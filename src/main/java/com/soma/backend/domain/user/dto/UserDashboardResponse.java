 ...
 * (파트너 홈 GET /adjusters/me/home 대칭). {@code activeReport}·{@code proposalSummary}는 해당 없음 시
 * null이고, {@code reportCount} 0이면 프론트가 온보딩을 렌더한다. 필드는 Jackson 전역 설정에 따라
 * snake_case로 직렬화된다(report_count·active_report 등).
 */
