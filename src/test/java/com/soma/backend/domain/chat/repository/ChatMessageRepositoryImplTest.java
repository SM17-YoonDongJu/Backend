...
class ChatMessageRepositoryImplTest {
  ...
  @BeforeEach
  void setUp() {
    User customer = userRepository.save(User.create("고객", LocalDate.of(1990, 1, 1), "F", null, null, Role.USER, null));
  ...
  void findByCursor_scopesToRoom() {
    User otherCustomer = userRepository.save(
        User.create("타객", LocalDate.of(1990, 1, 1), "F", null, null, Role.USER, null));
