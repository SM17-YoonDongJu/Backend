...
/**
 * 손해사정사 마이페이지/프로필 조회·수정. 인증된 사정사(미인증·인증)만 접근한다.
 * {@code /adjusters/me/profile}는 프로필 수정 화면 초기값(flat) 조회와 부분 수정(PATCH)을,
 * {@code /adjusters/me/mypage}는 마이페이지 4개 섹션(프로필·통계·당월 활동·자격)을 내린다.
 */
@RestController
...
public class AdjusterProfileController {
  ...
  private final AdjusterProfileCommandService adjusterProfileCommandService;
