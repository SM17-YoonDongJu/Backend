...
public record ChatReportRequest(
    @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "ChatReportReason enum 이름") String reason,
    @Schema(nullable = true, description = "reason이 OTHER면 필수(공백만이면 누락 취급), 최대 500자") String reasonDetail) {
}
